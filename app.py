...
║   Compatible: Python 3.8 / 3.9 / 3.10 / 3.11                   ║
║                                                                  ║
║   STEP 1 — Uninstall broken old versions first:                  ║
...
║                                                                  ║
║   STEP 3 — Run:                                                  ║
║     streamlit run stock_lstm_app.py                              ║
╚══════════════════════════════════════════════════════════════════╝

WHY JSONDecodeError / No timezone found:
  yfinance 0.2.18 uses a Yahoo Finance API endpoint that Yahoo has
  deprecated and blocked. Versions 0.2.40+ use the new v8 API
  endpoint that still works. Simply upgrading fixes all three errors
  you saw (TypeError, No timezone, JSONDecodeError).
"""
